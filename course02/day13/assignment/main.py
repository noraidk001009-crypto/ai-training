...
def play_one_fight():
    ...
    fights = 0 #定义fights
    defends = 0
    heals = 0  # MVP has no heal command; column kept for the data plan #定义heals
    ...
    print("Commands: fight / defend / quit") #打印Commands: fight / defend / quit
    ...
    while player_hp > 0 and boss_hp > 0:
        ...
        if cmd == "fight":
            ...
            print("Unknown command. Use: fight, defend, quit") #打印Unknown command. Use: fight, defend, quit
            continue
